...
CREATE TABLE `chitietchuyenbay` (
  ...
  KEY `ma_ve` (`ma_ve`),
  CONSTRAINT `chitietchuyenbay_ibfk_1` FOREIGN KEY (`ma_chuyen_bay`) REFERENCES `chuyenbay` (`ma_chuyen_bay`),
  CONSTRAINT `chitietchuyenbay_ibfk_2` FOREIGN KEY (`ma_ve`) REFERENCES `ve` (`ma_ve`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `chitietchuyenbay`
--

LOCK TABLES `chitietchuyenbay` WRITE;
